...
const ja = {
  ...
  // Dialog
  WidgetDialog: {
    title: 'Dialog Widgetの使い方と応用例 - Flutter図鑑',
    0: (
      <>
    ...
    1: (
      <>
        Flutterでは<code>showDialog</code>
        関数を使用してダイアログを呼び出すことができます。
        <br />
        ダイアログを閉じたい場合は、<code>Navigator.pop(context)</code>
        を使用して閉じることができます。
      </>
    ),
    '2_head': '全画面のダイアログ',
    2: (
      <>
        全画面のダイアログを表示するためには<code>Dialog.fullscreen</code>
        で対応することができます。
        <br />
    ...
    4: (
      <>
        <code>showGeneralDialog</code>
        は高度なダイアログを実装する場合や、特定のデザインを持つダイアログを作成する際に使用されます。
        <br />
